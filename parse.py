...
sad = scrap(sad_1,'sad') + scrap(sad_2, 'sad') + scrap(sad_3, 'sad') + scrap(sad_4, 'sad') + scrap(sad_5, 'sad') + scrap(sad_6, 'sad')
...
midnight5_html = requests.get('https://www.melon.com/mymusic/dj/mymusicdjplaylistview_inform.htm?plylstSeq=415828654', headers=header).text
midnight5_bs = BeautifulSoup(midnight5_html, "html.parser")
midnight_5 = midnight5_bs.select('tr')[1:]

midnight = scrap(midnight_1, 'midnight') + scrap(midnight_2, 'midnight') + scrap(midnight_3, 'midnight') + scrap(midnight_4, 'midnight') + scrap(midnight_5, 'midnight')
...
love = scrap(love_1, 'love') + scrap(love_2, 'love') + scrap(love_3, 'love') + scrap(love_4, 'love') + scrap(love_5, 'love') + scrap(love_6, 'love')
